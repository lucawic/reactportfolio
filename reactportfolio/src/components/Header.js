    ...
    <section id="testimonials">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-80 inline-block text-blue-300 justify-center" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className=" justify-center">
              <h1 className="text-gray-900 bg-purple-50 shadow-2xl p-5 w-full text-5xl mb-16 my-10 justify-center"> Lucas Wick <span className="text-7xl ">|||</span>  <span className="text-2xl ml-2 font-bold">Web Developer</span></h1>
          </div>
